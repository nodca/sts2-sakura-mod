...
public class ClassicNothingMonsterPower : SakuraPowerModel
{
    private const int ExhaustChance = 10;

    protected override string IconFileName => "nothing_monster.png";
    ...
    {
        if (card.Owner?.Creature != Owner || card is not SakuraSourceCard { IsClassicSourceCard: true })
