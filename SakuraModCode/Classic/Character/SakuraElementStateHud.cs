...
internal static class SakuraElementStateHud
{
    ...
    private sealed class HudState : IDisposable
    {
        ...
        public HudState(Player player, CombatState combatState, Control root)
        {
            ...
            _slots =
            [
                new(root.GetNode<TextureRect>("%WindFacet"), SakuraElementFacet.Wind, SakuraActiveElementStates.Windy, ClassicElement.Windy),
                new(root.GetNode<TextureRect>("%FireFacet"), SakuraElementFacet.Fire, SakuraActiveElementStates.Firey, ClassicElement.Firey),
                new(root.GetNode<TextureRect>("%EarthFacet"), SakuraElementFacet.Earth, SakuraActiveElementStates.Earthy, ClassicElement.Earthy),
                new(root.GetNode<TextureRect>("%WaterFacet"), SakuraElementFacet.Water, SakuraActiveElementStates.Watery, ClassicElement.Watery),
            ];
        ...
        private void ShowHoverTip(SakuraElementFacet facet)
        {
            ...
            var key = ClassicSakuraCardText.ClassicElementStateTipKey(element);
    ...
    private sealed class ElementSlot : IDisposable
    {
        ...
        public ClassicElement Element { get; }
