...
public class ClowFloat() : ClowCard(1, CardType.Power, CardRarity.Uncommon, TargetType.None)
{
...
public class SakuraFloat() : SakuraFormCard(1, CardType.Power, TargetType.None)
{
    public override SakuraElementSet Elements => SakuraElementSet.Wind;
...
internal static class SakuraFreezeRules
{
